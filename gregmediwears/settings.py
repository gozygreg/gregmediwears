"""
Django settings for gregmediwears project.
...
SECRET_KEY = 'django-insecure-7lr96aed2kg2zgmg!zj5f1b8mfnv0(h&co0ljg638!cj&c%t7^'
...
ROOT_URLCONF = 'gregmediwears.urls'
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER')  # Enter your Gmail address
...
WSGI_APPLICATION = 'gregmediwears.wsgi.application'
